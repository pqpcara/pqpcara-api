...
The examples below are all configurations defined in the `package.json` file.
...
Every time you save changes to the code, it will automatically reload and test in real time.
```bash
bun run dev
```
